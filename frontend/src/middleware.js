...
var astro_middleware_1 = require("astro:middleware");
var client_1 = require("astro:env/client");
exports.onRequest = (0, astro_middleware_1.defineMiddleware)(function (context, next) { return __awaiter(void 0, void 0, void 0, function () {
    var cookies, redirect, cookie, responseCekCookie, resultCekCookie, e_1;
